...
class TestCdataset(unittest.TestCase):
    """tests Cdataset class"""
    ...
    def test_dict(self):
        ...
        cdts = Cdataset(
            [
                ...
                Cfield(
                    [200, 200, 300, 200, 300, 300], "i3", default=True
                ),  # derived from root
...
class TestAnaFieldAnaRelation(unittest.TestCase):
    """tests AnaField, AnaRelation classes"""

    def test_creation(self):
        """tests AnaField, AnaRelation"""
        self.assertEqual(
            i0.to_dict(idfield=True),
            {"lencodec": 6, "mincodec": 6, "maxcodec": 6, "id": "i0"},
        )
        self.assertEqual(
            i0.to_dict(full=True),
            {
                "lencodec": 6,
                "mincodec": 6,
                "maxcodec": 6,
        ...
        self.assertEqual(
            i2i1.to_dict(relation=True, mode="id"),
            {
                "dist": 3,
                "parentchild": False,
                "relation": ["i2", "i1"],
        ...
        self.assertEqual(
            i2i1.to_dict(relation=True, distances=True, mode="id"),
            {
                "dist": 3,
                "relation": ["i2", "i1"],
                "typecoupl": "derived",
        ...
        self.assertEqual(
            i2i1.to_dict(full=True, mode="id"),
            {
                "dist": 3,
                "relation": ["i2", "i1"],
                "typecoupl": "derived",
        ...
        self.assertTrue(
            dts.relations[AnaDfield(i1, dts)][AnaDfield(i2, dts)].dist
            == dts.relations[AnaDfield(i2, dts)][AnaDfield(i1, dts)].dist
            == 3
        )
        self.assertTrue(
            dts.relations[AnaDfield(i1, dts)][AnaDfield(i3, dts)].dist
            == dts.relations[AnaDfield(i3, dts)][AnaDfield(i1, dts)].dist
            == 6
        )
    ...
    def test_field_typology(self):
        """tests AnaField, AnaRelation"""
        self.assertEqual(
            [fld.category for fld in dts.fields],
            [ROOTED, MIXED, DERIVED, DERIVED, COUPLED],
        )
        self.assertEqual(
            [fld.p_derived.idfield for fld in dts.fields],
            [ROOT, ROOT, "i1", ROOT, "i3"],
        )
        self.assertEqual(
            [fld.typecodec for fld in dts.fields],
            [COMPLETE, DEFAULT, DEFAULT, DEFAULT, DEFAULT],
        )
        self.assertEqual(
            [fld.p_distance for fld in dts.fields],
            [dts.root, dts.root, dts.fields[1], dts.fields[2], dts.fields[3]],
        )
        self.assertEqual(
            [fld.ascendants() for fld in dts.fields],
            [[], [], [dts.fields[1]], [], [dts.fields[3]]],
        )
        self.assertEqual(
            [fld.ascendants("distance") for fld in dts.fields],
            [
                [],
                [],
                [dts.fields[1]],
                [dts.fields[2], dts.fields[1]],
    ...
    def test_tree(self):
        ...
        self.assertEqual(
            dts.tree("distance", string=False),
            {
                "-1": [
                    "root-distance (6)",
                    {"0 ": ["i0 (0 - 6)"]},
        ...
        self.assertEqual(
            dts.tree("distomin", string=False),
            {
                "-1": [
                    "root-distomin (6)",
                    {
...
class TestAnaDataset(unittest.TestCase):
    ...
    def test_sdataset(self):
        ...
        self.assertEqual(
            ilm.analysis.partitions(mode="index"),
        ...
        self.assertEqual(
            ana.field_partition(mode="index", partition=ana.partitions()[1]),
            {
                "mixte": [],
                "primary": [2, 5, 8],
                "secondary": [],
                "unique": [10],
                "variable": [0, 1, 3, 4, 6, 7, 9],
            },
        )
    ...
    def test_partitions(self):
        ...
        self.assertEqual(
            ilm.analysis.field_partition(mode="index"),
            {
                "mixte": [],
                "primary": [0],
                "secondary": [1, 2, 3, 4],
        ...
        ilm = Sdataset.ntv(
            [
                ["math", "english", "software", "physic", "english", "software"],
        ...
        ilm = Cdataset.from_ntv(
            [
                ["math", "english", "software", "math", "english", "software"],
                ["philippe", "philippe", "philippe", "anne", "anne", "anne"],
                [None, None, None, "gr1", "gr1", "gr2"],
                [
                    "philippe white",
